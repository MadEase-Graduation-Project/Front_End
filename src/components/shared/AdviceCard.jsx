...
export default function AdviceCard({
  ...
  const handleNavigate = () => {
    navigate(`${link}/${advice._id}`, {
      state: { selectedCategory }, // preserve the filter
    });
  };
      ...
      >
        ...
        <div className="py-4 px-7 flex-1 flex flex-col">
          <div className="flex-1 flex flex-col">
            <p className="block mt-2 text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-6 flex items-center">
            <div className="flex-shrink-0">
              <img
                ...
                src="https://res.cloudinary.com/dweffiohi/image/upload/v1745583748/wn6wqxmsalbweclrngrn.jpg"
                alt={"Doctor"}
              />
            </div>
            <div className="ml-3">
